...
import { ChevronLeft, ChevronRight } from "lucide-react"; // Updated import
...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          // "duration-300 top-0 h-svh  z-10 hidden  w-(--sidebar-width) transition-[left,right,width] ease-in-out md:flex",
          // side === "left"
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex  w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-md group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      {open ? (
        <ChevronLeft className="size-5.5" size={22} aria-hidden="true" />
      ) : (
        <ChevronRight className="size-5.5" size={22} aria-hidden="true" />
      )}
